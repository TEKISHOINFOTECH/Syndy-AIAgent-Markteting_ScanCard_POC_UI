...
export function LandingScreen({ onStartScan, activeView = 'cardscanner', onNavClick }: LandingScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col px-4 sm:px-6 overflow-y-auto pb-6 relative">
      <motion.div
        ...
        <div className="grid md:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="backdrop-blur-xl rounded-2xl p-4 sm:p-6 border transition-colors shadow-sm" style={{background: 'rgba(22, 35, 71, 0.8)', borderColor: 'rgba(59, 130, 246, 0.3)'}}
            >
