...
const AvatarScreen: React.FC<AvatarScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 pb-6 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <button
            onClick={onGoBack}
            className="flex items-center gap-2 px-4 py-2 bg-slate-700/80 text-gray-200 rounded-lg font-medium hover:bg-slate-600/80 hover:text-white transition-all border border-slate-600/50 hover:border-slate-500/50 shadow-sm"
          >
            <ArrowLeft className="w-5 h-5" />
            <span className="hidden sm:inline">Previous</span>
          </button>

          <div className="flex items-center gap-3 px-4 py-2 bg-slate-800/90 rounded-lg shadow-sm border border-slate-700/50">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-gray-300">Step 3 of 6</span>
            </div>
            <div className="w-px h-4 bg-slate-600"></div>
            <span className="text-sm font-medium text-gray-200">AI Avatar Chat</span>
          </div>

          <button
            onClick={handleContinueToSelfie}
            className="flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all shadow-md bg-gradient-to-r from-blue-500 to-emerald-500 text-white hover:from-blue-600 hover:to-emerald-600 hover:shadow-lg"
          >
              ...
              <div className="text-center">
                ...
                <div className="space-y-3">
                  ...
                  <motion.button
                    ...
                    className="w-full text-white px-6 py-3 rounded-xl font-medium transition-colors" style={{background: 'rgba(22, 35, 71, 0.8)', borderColor: 'rgba(59, 130, 246, 0.3)'}}
                  >
                    Review Session
                  </motion.button>
                </div>
