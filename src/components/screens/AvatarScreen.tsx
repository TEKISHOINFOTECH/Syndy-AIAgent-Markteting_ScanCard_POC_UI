...
const AvatarScreen: React.FC<AvatarScreenProps> = ({
  ...
  useEffect(() => {
    ...
    const avatarUrl = `https://syndy-ai-agent-avatar-voice-agent-aria-ggoopcalp.vercel.app/?returnUrl=${returnUrl}&step=selfie&source=card-scanner`;
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      if (event.origin !== 'https://syndy-ai-agent-avatar-voice-agent-aria-ggoopcalp.vercel.app/') {
