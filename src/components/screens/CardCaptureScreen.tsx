...
export function CardCaptureScreen({ onCapture, onCancel, onPrevious, onNext }: CardCaptureScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-start justify-center pt-1 px-3 sm:px-4 md:px-6 overflow-y-auto pb-6">
      <motion.div
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-5 p-3 sm:p-4 md:p-5">
            ...
            <div className="flex items-center justify-between mb-1">
              ...
              <button
                ...
                className="p-1.5 sm:p-2 rounded-lg transition-colors flex-shrink-0 text-gray-300 hover:text-white"
                style={{background: 'rgba(22, 35, 71, 0.6)'}}
                aria-label="Cancel"
              >
            ...
            {/* Capture Area */}
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden min-h-[280px] sm:min-h-[350px] md:min-h-[400px] flex items-center justify-center mt-2" style={{background: 'rgba(22, 35, 71, 0.3)'}}>
              {/* Upload Mode */}
              ...
              {/* Validating Overlay */}
              {isValidating && (
                <div className="absolute inset-0 flex items-center justify-center" style={{background: 'rgba(14, 26, 59, 0.9)'}}>
                  <div className="text-center">
                    ...
                    />
                    <p className="text-gray-300">Validating...</p>
                  </div>
                </div>
              )}
            </div>
