  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-purple-50 via-white to-purple-100 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-white/70 backdrop-blur-xl border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 shadow-sm">
        <h2 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent">Scan Code</h2>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          {!isScanning ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <div className="p-5 sm:p-6 bg-gradient-to-br from-purple-100 to-violet-100 rounded-3xl group-hover:scale-110 transition-all duration-300 shadow-lg backdrop-blur-sm border border-purple-200">
                    <QrCode className="w-10 h-10 sm:w-12 sm:h-12 text-purple-500 drop-shadow-sm" />
                  </div>
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <div className="p-5 sm:p-6 bg-gradient-to-br from-purple-100 to-violet-100 rounded-3xl group-hover:scale-110 transition-all duration-300 shadow-lg backdrop-blur-sm border border-purple-200">
                    <Nfc className="w-10 h-10 sm:w-12 sm:h-12 text-purple-500 drop-shadow-sm" />
                  </div>
                  <div className="text-center">
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
                      NFC Card
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-4">
                  <div className="p-5 sm:p-6 bg-gradient-to-br from-purple-100 to-violet-100 rounded-3xl group-hover:scale-110 transition-all duration-300 shadow-lg backdrop-blur-sm border border-purple-200">
                    <FileText className="w-10 h-10 sm:w-12 sm:h-12 text-purple-500 drop-shadow-sm" />
                  </div>
                  <div className="text-center">
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2">
                      Text Scan
            ...
            <div className="bg-white/70 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
              <div className="bg-gradient-to-r from-purple-500 to-violet-500 backdrop-blur-xl px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between shadow-lg">
              ...
              <div className="p-4 sm:p-6 lg:p-8 flex flex-col items-center gap-4">
                {scanMode === 'qr' && (
                  <>
                    ...
                    <div className="mb-4 p-3 sm:p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                      <div className="text-center">
                      ...
                      <button
                        ...
                        className="px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-purple-500 to-violet-500 text-white rounded-2xl hover:from-purple-600 hover:to-violet-600 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 font-semibold text-sm sm:text-base flex-1 sm:flex-none"
                      >
                    ...
                    {enrichResults && enrichResults.qr_codes && enrichResults.qr_codes.length > 0 && (
                        ...
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 backdrop-blur-xl rounded-2xl p-3 sm:p-4 border border-purple-200">
                          ...
                          <div className="space-y-3">
                            {enrichResults.qr_codes.map((qr: any, index: number) => (
                              <div key={index} className="bg-white/70 rounded-xl p-3 sm:p-4 border border-purple-200">
                                    ...
                                    <div className="mt-1 space-y-1">
                                      {Object.entries(qr.parsed.details).map(([key, value]: [string, any]) => (
                                        <div key={key} className="flex items-start gap-2 text-xs sm:text-sm">
                                          <span className="font-medium text-purple-600 capitalize min-w-20">
                                            {key.replace('_', ' ')}:
                                          </span>
                                ...
                                <div className="mt-3 flex gap-2 flex-wrap">
                                  <button
                                    ...
                                    className="px-2 sm:px-3 py-1 bg-purple-500 text-white text-xs rounded-lg hover:bg-purple-600 border border-purple-400"
                                  >
                                    Copy Data
                                  </button>
                              ...
                              <div className="p-3 bg-gray-50 rounded-lg">
                                ...
                                {enrichResults.company_info.website && (
                                  <button
                                    ...
                                    className="text-purple-600 text-xs hover:text-purple-700 underline mt-1 flex items-center gap-1"
                                  >
